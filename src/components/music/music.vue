            ...
            <div class="control-side">
                ...
                <div class="controls">
                    <button class="control-btn" @click="previousTrack" :disabled="playlist.length <= 1">
                        <img :src="imgNext" style="width: 15px;transform: rotate(180deg) ;opacity: 0.5">
                    </button>
                    <button class="control-btn play-btn" @click="togglePlay">
                        <img :src="isPlaying ? imgPause : imgPlay" alt="播放/暂停" class="icon-btn"style="opacity: 0.5" />
                    </button>
                    <button class="control-btn" @click="nextTrack" :disabled="playlist.length <= 1">
                        <img :src="imgNext" style="width: 15px;opacity: 0.5">
                    </button>
                </div>
